...
public class GetCalfResultMasterData extends GenericBase{
	
NitaraService results = new NitaraService();
	
	@Test(groups= {"Smoke"})
	public void getCalfResultMasterData() throws IOException 
	
	{ 
				
		Response rs = results.GetAll(prop.getProperty("baseurl"), prop.getProperty("GetCalfResultMasterData"),token);
