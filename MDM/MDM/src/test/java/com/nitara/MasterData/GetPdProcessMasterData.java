...
public class GetPdProcessMasterData extends GenericBase {

	NitaraService results = new NitaraService();
	
	@Test(groups= {"Smoke"})
	public void GetPdProcessMasterDataInEnglish() throws IOException 
	
	{ 
				
		Response rs = results.GetAll(prop.getProperty("baseurl"), prop.getProperty("GetPdProcessMasterData"),token);
