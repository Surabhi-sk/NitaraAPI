...
public class GetGenderTypeMasterData extends GenericBase {

	NitaraService results = new NitaraService();
	
	@Test(groups= {"Smoke"})
	public void GetGenderTypeMasterDataInEnglish() throws IOException 
	
	{ 
				
		Response rs = results.GetAll(prop.getProperty("baseurl"), prop.getProperty("GetGenderTypeMasterData"),token);
