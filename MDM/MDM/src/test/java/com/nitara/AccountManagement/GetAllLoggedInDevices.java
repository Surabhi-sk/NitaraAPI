...
public class GetAllLoggedInDevices extends GenericBase 
{

	NitaraService results = new NitaraService();

	@Test(groups= {"Smoke"})
	public void getAllLoggedInDevices() throws IOException 

	{ 
		System.out.println("Get All Logged in Devices");
		Response rs = results.GetAll(prop.getProperty("baseurl"), prop.getProperty("GetAllLoggedInDevices"),token);
