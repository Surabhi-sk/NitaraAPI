...
public class GetUserHealthPreferences extends GenericBase{

	NitaraService results = new NitaraService();
	
	@Test(groups= {"Smoke"})
	public void getUserHealthPreferences() {
		Response rs = results.GetAll(prop.getProperty("baseurl"), prop.getProperty("GetUserHealthPreferences"),token);
	...
	public String getUserHealthPreferences(String token) {
		Response rs = results.GetAll(prop.getProperty("baseurl"), prop.getProperty("GetUserHealthPreferences"),token);
