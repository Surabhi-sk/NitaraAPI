...
public class GetUserServicesPreferences extends GenericBase{

	NitaraService results = new NitaraService();

	@Test(groups= {"Smoke"})
	public void getUserServicesPreferences() {

		Response rs = results.GetAll(prop.getProperty("baseurl"), prop.getProperty("GetUserServicesPreferences"),token);
	...
	public String getUserServicesPreferences(String token) {
