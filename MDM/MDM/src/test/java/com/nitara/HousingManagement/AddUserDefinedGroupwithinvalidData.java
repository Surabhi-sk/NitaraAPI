...
public class AddUserDefinedGroupwithinvalidData extends GenericBase
{
	NitaraService results = new NitaraService();
	
 
	@Test(groups= {"Smoke"})
	public void AddUserDefinedGroup() throws IOException 
	{
		...
		RequestSpecification request = RestAssured.given();
		 ...
		 queryParam.put("shedname", "Ravidefinedshedt");	 
		 queryParam.put("Groups", Arrays.asList("Ravidefinedgroup1t", "Ravidefinedgroup2t"));
