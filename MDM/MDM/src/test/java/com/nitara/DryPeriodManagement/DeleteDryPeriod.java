...
public class DeleteDryPeriod extends GenericBase{
	...
	@Test(groups= {"Smoke"})
	public void deleteDryPeriod() throws Exception {
		String abstractname = prop.getProperty("DeleteDryPeriod");
		...
		Assert.assertEquals("Dry Period data removed Successfully.", message);
