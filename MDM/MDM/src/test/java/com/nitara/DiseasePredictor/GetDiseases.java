...
public class GetDiseases extends GenericBase{
	...
	public void GetDiseases() 
	{
		...
		String abstractname = prop.getProperty("GetDiseases");
		RestAssured.baseURI = prop.getProperty("baseurl"); 

		RequestSpecification request = RestAssured.given();
		
	/*	HashMap<String, Object> queryparams = new HashMap<>();
		queryparam.put("symptomIdList", Arrays.asList("Disease_EphemeralFever", "Disease_FMD"));*/

		String disease[] = new String[] {"Symptom_BleedingFromOrifices","Symptom_Jaundice"};
...
//		request.body(list.toString());
		...
		Assert.assertEquals("Disease Data.", message);
