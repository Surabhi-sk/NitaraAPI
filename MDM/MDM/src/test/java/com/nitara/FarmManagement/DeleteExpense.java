...
public class DeleteExpense extends GenericBase{
	
	@Test(groups= {"Smoke"})
	public void deleteExpense() throws Exception 
	{

		String abstractname = prop.getProperty("DeleteExpense");
		...
		Assert.assertEquals(message,"Expense data removed successfully.");
	}			
