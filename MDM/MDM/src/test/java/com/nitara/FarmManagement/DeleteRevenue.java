...
public class DeleteRevenue extends GenericBase{
	
	@Test(groups= {"Smoke"})
	public void deleteRevenue() throws Exception 
	{

		String abstractname = prop.getProperty("DeleteRevenue");
		...
		Assert.assertEquals(message,"Revenue data removed successfully.");
	}			
