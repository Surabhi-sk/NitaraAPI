...
public class ViewFarmAnalysiswithinvaliddata extends GenericBase
{
	NitaraService results = new NitaraService();


	@Test(groups= {"Smoke"})
	public void ViewFarmAnalysis() throws IOException 
	{
		...
		requestParams.put("farmId", "d4ebdeeb-8b42-4ab8-9380-eda28177c182g"); // Cast
